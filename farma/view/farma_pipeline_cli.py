...
from farma.model.common import valid_date
from farma.model.pipelines.farma_pipeline import MyPackagePipeline


# -----------------------------------------------------------------------------
# main
#
# python farma_pipeline_cli.py -c config.yaml -sd 2023-04-05 \
#   -ed 2023-04-05 -s all
# -----------------------------------------------------------------------------
def main():
